...
function calculate(){
    ...
    let time = date.slice(15,21)
    let timezone = date.slice(-26,-1)
    document.getElementById('demo').innerHTML = "Date: " + newdate;
    document.getElementById('demo2').innerHTML = "Time: " + time;
    document.getElementById('demo3').innerHTML = "Time Zone: " + timezone;
    console.log(date)
...
function printq(){
    ...
    let x = Number(newtime);

    document.getElementById('date').innerHTML = "Date: " + newdate
    if ( x <= 12){
    document.getElementById('time').innerHTML = "Time: " + time + " AM"
    
    }
    else{document.getElementById('time').innerHTML = "Time: " + time + " PM"}
